...
public class Product
{
	...
	@NotBlank(message = "Please enter acm_comp_code")
	@Size(max=12, message = "Acm_comp_code should be atleast 12 characters")
	private String acm_comp_code;
	
	@NotBlank(message = "Please enter acm_prod_code")
	@Size(max=12, message = "Acm_prod_code should be atleast 12 characters")
